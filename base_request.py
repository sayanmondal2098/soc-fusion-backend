...
class OTXPulseSummaryResponse(BaseResponse):
    id: str | None = None
    name: str | None = None
...
class OTXIndicatorLookupResponse(BaseResponse):
    provider: str
    indicator: str
    indicator_type: str
    otx_indicator_type: str
    source: str
    found: bool
    object_id: str | None = None
    pulse_count: int
    ...
    pulses: list[OTXPulseSummaryResponse]
    details: dict[str, object]
    detail_errors: dict[str, object]
    link: str


class OTXIndicatorBatchItemResponse(BaseResponse):
    indicator: str
    indicator_type: str
    success: bool
    result: OTXIndicatorLookupResponse | None = None
    error: dict[str, object] | None = None


class OTXIndicatorBatchLookupResponse(BaseResponse):
    total: int
    success_count: int
    failure_count: int
